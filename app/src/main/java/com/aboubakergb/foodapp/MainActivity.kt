...
class MainActivity : AppCompatActivity() {
    ...
    private val foodList = listOf(
        Food(
            R.drawable.recipe_1, "الكيكة اليومية الإسفنجية",
        ...
        Food(
            R.drawable.recipe_8, "حلوة الفرشيطة بالشكولاطة والمربى ",
            "المقادير : \n" +
        ...
        Food( R.drawable.recipe_10, "البسبوسة بوصفة سهلة",
            "المقادير:\n" +
        ...
        Food( R.drawable.recipe_11, "بيسكوي رولي سريع بمعجون المشمش",
            "المقادير :\n" +
        ...
        Food( R.drawable.recipe_12, "مادلين بالشوكولاطة",
            "\n" +
                    "طرق تزيين المادلان :\n" +
        ...
        Food( R.drawable.recipe_13, "حلوة البيستولي",
        ...
        Food( R.drawable.recipe_14, "بسبوسة محشية بالكريمة",
            "\n" +
                    "المكونات :\n" +
